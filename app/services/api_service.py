...
class ApiService:
    ...
    async def check_apis(
        ...
        """
        apis = api_list or [
            {"name": "Workitems Poll", "method": "GET", "url": "https://backend-uw-workbench-dff0feemdwb4f4c6.canadacentral-01.azurewebsites.net/api/workitems/poll"},
            {"name": "Submissions", "method": "GET", "url": "https://backend-uw-workbench-dff0feemdwb4f4c6.canadacentral-01.azurewebsites.net/api/submissions"}
        ]
